package com.example.root.garminblecompteur.fontsClass;
...
public class ElectronicFontTextView extends android.support.v7.widget.AppCompatTextView {

    public ElectronicFontTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
